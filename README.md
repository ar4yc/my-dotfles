...
### ⚠️ Warning!
#### Конфиг в предназначен под 21:9 мониторов (2560x1080), при использовании монитора со соотношением 16:9 <br> **прийдется** переделывать правила окон #
##### Как выглядит: ############
...
https://github.com/lotos-linux/hypr-dock
